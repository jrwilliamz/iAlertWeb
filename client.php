...
<header class="row">
	<div class="span12">
      ...
      <li class="divider-vertical"></li>
      <li class="dropdown">
    <a href="#" class="dropdown-toggle" data-toggle="dropdown">News</b></a>
  ...
  <li class="media">
   <h4 class="media-heading">'.$r["title"].'</h4>
    <a class="pull-left" href="#">
      <img  id="hover" class="media-object" src="ialert/image_uploads/'.$r["face_image"].'" alt="IMAGE" height="100" width="250">
    </a>
